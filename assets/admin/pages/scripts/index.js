...
//                    toLabel: 'To',
                    ...
                    daysOfWeek: ['Mng', 'Sen', 'Sel', 'Rab', 'Kam', 'Jum', 'Sab'],
...
//            function (start, end) {
//                $('#dashboard-report-range span').html(start.format('D MMMM YYYY') + ' - ' + end.format('MMMM D, YYYY'));
//            }
            );
            ...
            function showDate(){
                var now = moment();
                now.locale('id');
                $('#dashboard-report-range span').html(now.format('dddd, D MMMM YYYY HH:mm:ss'))
            }
