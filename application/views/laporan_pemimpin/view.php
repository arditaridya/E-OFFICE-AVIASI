...
<html lang="en" class="no-js">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            <li>
                                ...
                                <a href="<?php echo site_url('laporan_pemimpin') ?>"><b>Laporan Data Aset</b></a>
  ...
  <ul class="nav nav-pills">
    <li class="active"><a data-toggle="pill" href="#home">Data Aset Keseluruhan</a></li>
    <li><a data-toggle="pill" href="#menu1">Berdasarkan Dasar Perolehan</a></li>
  </ul>
                                           ...
                                           foreach ($datanyax as $row) {
											   $zakzak = $row->id; 
                                                ...
                                                <tr class="odd gradeX" >
                                                    ...
                                                    <td><a href="<?php echo site_url("laporan_pemimpin/laporan_perpangkalan/$zakzak") ?>"><?php echo $row->kotama; ?></a></td>
													<td align="right">
													<?php 
