                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo site_url('jenis_material'); ?>">List Jenis Material</a>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box blue">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="<?php echo base_url('jenis_material/simpanedit'); ?>" class="horizontal-form" method="post">
                                       
                                    <?php foreach($dataper as $value){ ?>
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <label class="control-label col-md-3">Nama Jenis Material</label>
                                                    <div class="form-group">
                                                        <div class="col-md-6">
                                                            <input type="text" class="form-control" name="nama_jenismaterial" id="nama_jenismaterial" value="<?php echo $value->nama_jenismaterial;?>">
															<input type="hidden" class="form-control" name="id_jenismaterial" id="id_jenismaterial" value="<?php echo $value->id_jenismaterial;?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
