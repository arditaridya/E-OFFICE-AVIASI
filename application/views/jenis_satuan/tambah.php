                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo base_url('jenis_satuan/simpanjenissatuan'); ?>" class="horizontal-form" method="post">
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" name="nama_jenissatuan" id="nama_jenismaterial" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-6">
                                                    <textarea rows="5" class="form-control" name="keterangan" id="keterangan" style="resize: none" required></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
