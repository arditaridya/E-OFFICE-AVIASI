                        ...
                        <div class="portlet-body" style="background-color:#99ccff;">
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <a href="<?php echo site_url('jenis_satuan/tambahsatuan') ?>">
                            ...
                            <table class="table table-striped table-bordered table-hover table-responsive" id="sample_6">
                                ...
                                <tr bgcolor="#ccccff">
                                    ...
                                    <th><center>Nama Jenis Satuan</center></th>
                                ...
                                foreach ($model as $row) {
                                    ...
                                    <tr class="odd gradeX" bgcolor="#ccccff">
                                        <td><?php echo $no; ?></td>
                                        <td><?php echo $row->nama_jenissatuan; ?></td>
                                        ...
                                        <td>
                                            <center>
                                                <a href="<?php echo base_url('jenis_satuan/editjenissatuan/' . $row->id_jenissatuan . ''); ?>" class="btn btn-primary">
                                                    <i class="fa fa-pencil"> Edit</i>
                                                </a>
                                                <a href="<?php echo site_url('jenis_satuan/hapus/' . $row->id_jenissatuan . '') ?>">
