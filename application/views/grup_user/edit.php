                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo site_url('grup_user'); ?>">List Grup User</a>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box blue">
								...
								<?php foreach($datanya as $value){ ?>
                                    <form action="<?php echo base_url('grup_user/update'); ?>" class="horizontal-form" method="post">
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-4">
                                                            <input type="text" class="form-control" name="nama" id="nama" value="<?php echo $value->nama; ?>">
