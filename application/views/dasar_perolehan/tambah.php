                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo site_url('dasar_perolehan'); ?>">List Provinsi</a>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box blue">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="<?php echo base_url('dasar_perolehan/simpandaper'); ?>" class="horizontal-form" method="post">
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-3">
                                                            <input type="text" class="form-control" name="dasar_perolehan" id="dasar_perolehan">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
