                                ...
                                <div class="portlet-body" style="background-color:#99ccff;">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo site_url('dasar_perolehan/tambahdaper') ?>">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($model as $row) {
                                                ...
                                                <tr class="odd gradeX" bgcolor="#ccccff">
                                                    ...
                                                    <td><?php echo $row->dasar_perolehan; ?></td>
													<td><?php echo $row->keterangan; ?></td>
                                                    <td width="15%">
													<center>
                                                        <a href="<?php echo base_url('dasar_perolehan/editdaper/' . $row->id . ''); ?>" class="btn btn-primary">
                                                            <i class="fa fa-pencil"></i> 
                                                        </a>
                                                        <a href="<?php echo site_url('dasar_perolehan/hapus/' . $row->id . '') ?>">
