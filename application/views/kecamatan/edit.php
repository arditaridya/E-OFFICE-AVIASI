                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box blue">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="<?php echo base_url('kecamatan/simpanedit'); ?>" class="horizontal-form" method="post">
										...
										<div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-4">
                                                            <input type="text" class="form-control" name="nama_kecamatan" id="nama_kecamatan" value="<?php echo $value->nama_kecamatan;?>"> 
															<input type="hidden" class="form-control" name="id" id="id" value="<?php echo $value->id_kecamatan;?>"> 
