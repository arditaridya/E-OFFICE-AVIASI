                                ...
                                <div class="portlet-body" style="background-color:#99ccff;">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo site_url('kecamatan/tambahkecamatan') ?>">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($model as $row) {
                                                ...
                                                <tr class="odd gradeX" bgcolor="#ccccff">
                                                    ...
                                                    <td width="15%">
                                                        <a href="<?php echo base_url('kecamatan/editkecamatan/' . $row->id_kecamatan . ''); ?>" class="btn btn-primary">
                                                            <i class="fa fa-pencil"></i> 
                                                        </a>
                                                        <a href="<?php echo site_url('kecamatan/hapus/' . $row->id_kecamatan . '') ?>">
