                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="#"><?php echo $idmantra; ?>-Mabes TNI</a>
                            </li>
                        </ul>
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo site_url('c_kesatuan/tambah_mabes_tni/'.$idmantra.'') ?>">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="sample_2">
                                        ...
                                        <tbody>
                                            <?php
                                            $no = 1;
                                            foreach ($list_mabes_tni as $data) {
                                                ?>
                                                <!--<tr class="odd gradeX" onclick="document.location='<?php //echo base_url() . "c_kesatuan/detail_mabes_tni/" . $data->id; ?>'">-->
												<tr>
                                                    <td><?php echo $no; ?></td>
                                                    <td><a href="<?php echo site_url('c_kesatuan/mabes_tni2/'.$data->id) ?>" target="_blank" ><?php echo $data->id; ?></a></td>
                                                    <td><?php echo $data->kesatuan; ?></td>
                                                    <td>
                                                        <a href="<?php echo base_url() . "c_kesatuan/edit_mabes_tni/" . $data->id; ?>" class="btn default btn-xs green">
                                                            <i class="fa fa-edit"></i> Edit 
														</a>
                                                        <a href="<?php echo base_url() . "c_kesatuan/delete_mabes_tni/" . $data->id; ?>">
