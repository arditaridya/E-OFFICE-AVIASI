                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo site_url('c_kesatuan/mabes_tni/1'); ?>">Mabes TNI</a>
								<i class="fa fa-angle-right"></i>
                            </li>
							<li>
								<?php foreach ($mabes_tni_breadcrumb as $row) { ?>
                            ...
                            <div class="portlet box red">
                                <div class="portlet-title">
                                    <div class="caption">
                                        List Data Kesatuan 
										<?php 
											foreach ($mabes_tni_breadcrumb as $row){
												echo $row->kesatuan;
											} 
										?>
                                    </div>
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo site_url('c_kesatuan/tambah_mabes_tni2/'.$id.'') ?>">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="sample_2">
                                        ...
                                        <tbody>
                                            <?php
                                            $no = 1;
                                            foreach ($list_mabes_tni2 as $data) {
                                                ?>
												<tr>
                                                    <td><?php echo $no; ?></td>
                                                    <td><?php echo $data->id; ?></td>
                                                    <td>
														<?php echo $data->kesatuan; ?>
													</td>
                                                    <td>
                                                        <a href="<?php echo base_url() . "c_kesatuan/edit_mabes_tni2/" . $data->idinduk."/".$data->id; ?>" class="btn default btn-xs green">
                                                            <i class="fa fa-edit"></i> Edit 
														</a>
                                                        <a href="<?php echo base_url() . "c_kesatuan/delete_mabes_tni2/" . $data->idinduk."/".$data->id;; ?>">
