                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo site_url('c_kesatuan/mabes_tni/'.$id.''); ?>">Mabes TNI</a>
								<i class="fa fa-angle-right"></i>
                            </li>
							<li>
                                <a href="#">Edit Data</a>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box red">
                                ...
                                <div class="portlet-body">
                                    <!-- BEGIN FORM-->
									<?php foreach($mabes_tni as $row){ ?>
									<form action="<?php echo site_url('c_kesatuan/edit_mabes_tni/'.$row->id.'') ?>" class="horizontal-form" method = "post">
										<div class="form-body">
											<fieldset class="scheduler-border">
												<legend class="scheduler-border">Mabes TNI</legend>
												<div class="row">
													<div class="col-md-8">
														<div class="form-group">
															...
															<div class="form-group">
																<div class="col-md-5">
																	   <input type="text" name="KESATUAN" id="kesatuan" value="<?php echo $row->kesatuan; ?>" onkeyup="myFunction('kesatuan');" class="form-control" placeholder="kesatuan...">
																</div>
															</div>
														</div>
													</div>
