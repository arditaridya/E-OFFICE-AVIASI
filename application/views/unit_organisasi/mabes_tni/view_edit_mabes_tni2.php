                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
							...
							<li>
								<?php foreach ($mabes_tni_breadcrumb2 as $row) { ?>
                            ...
                            <div class="portlet box red">
                                <div class="portlet-title">
                                    <div class="caption">
                                        List Data Kesatuan
										<?php 
											foreach ($mabes_tni_breadcrumb2 as $row){
												echo $row->kesatuan;
											} 
										?>
                                    </div>
                                ...
                                <div class="portlet-body">
                                    <!-- BEGIN FORM-->
									<?php foreach($mabes_tni as $hole){ ?>
									<form action="<?php echo site_url('c_kesatuan/edit_mabes_tni2/'.$idinduk.'/'.$id) ?>" class="horizontal-form" method = "post">
										<div class="form-body">
											<fieldset class="scheduler-border">
												<legend class="scheduler-border">
													Mabes TNI <i class="fa fa-angle-right"></i>
													<?php 
														foreach ($mabes_tni_breadcrumb2 as $row){
															echo $row->kesatuan;
														} 
