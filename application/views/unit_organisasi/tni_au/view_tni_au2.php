                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo site_url('c_kesatuan/tni_au/4'); ?>">TNI AU</a>
								<i class="fa fa-angle-right"></i>
                            </li>
							<li>
								<?php foreach ($tni_au_breadcrumb as $row) { ?>
                            ...
                            <div class="portlet box red">
                                <div class="portlet-title">
                                    <div class="caption">
                                        List Data Kesatuan 
										<?php 
											foreach ($tni_au_breadcrumb as $row){
												echo $row->kesatuan;
											} 
										?>
                                    </div>
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo site_url('c_kesatuan/tambah_tni_au2/'.$id.'') ?>">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($list_tni_au2 as $data) {
												...
												<tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url() . "c_kesatuan/edit_tni_au2/" . $data->idinduk."/".$data->id; ?>" class="btn default btn-xs green">
                                                            <i class="fa fa-edit"></i> Edit 
														</a>
                                                        <a href="<?php echo base_url() . "c_kesatuan/delete_tni_au2/" . $data->idinduk."/".$data->id;; ?>">
