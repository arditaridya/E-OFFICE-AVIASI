                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo site_url('c_kesatuan/kodikau/4'); ?>">KODIKAU</a>
								<i class="fa fa-angle-right"></i>
                            </li>
							<li>
								<?php foreach ($kodikau_breadcrumb as $row) { ?>
                                <a href="#"><?php echo $row->lanud; ?></a>
								<?php } ?>
                            </li>
                        </ul>
                            ...
                            <div class="portlet box red">
                                <div class="portlet-title">
                                    <div class="caption">
                                        List Data Kesatuan 
										<?php 
											foreach ($kodikau_breadcrumb as $row){
												echo $row->lanud;
											} 
										?>
                                    </div>
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo site_url('c_kesatuan/tambah_kodikau2/'.$lanudId.'') ?>">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="sample_2">
                                        ...
                                        <tbody>
                                            <?php
                                            $no = 1;
                                            foreach ($list_kodikau2 as $data) {
                                                ?>
												<tr>
                                                    <td><?php echo $no; ?></td>
                                                    <td><?php echo $data->lanudId; ?></td>
                                                    <td>
														<?php echo $data->lanud; ?>
													</td>
                                                    <td>
                                                        <a href="<?php echo base_url() . "c_kesatuan/edit_kodikau2/" . $data->kotamaId."/".$data->lanudId; ?>" class="btn default btn-xs green">
                                                            <i class="fa fa-edit"></i> Edit 
														</a>
                                                        <a href="<?php echo base_url() . "c_kesatuan/delete_kodikau2/" . $data->kotamaId."/".$data->lanudId;; ?>">
