                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box red">
                                ...
                                <div class="portlet-body">
                                    <!-- BEGIN FORM-->
									<?php foreach($kodikau as $row){ ?>
									<form action="<?php echo site_url('c_kesatuan/edit_kodikau/'.$row->lanudId.'') ?>" class="horizontal-form" method = "post">
										<div class="form-body">
												...
												<div class="row">
													<div class="col-md-8">
														<div class="form-group">
															...
															<div class="form-group">
																<div class="col-md-5">
																	   <input type="text" name="LANUD" id="lanud" value="<?php echo $row->lanud; ?>" onkeyup="myFunction('lanud');" class="form-control" placeholder="kesatuan...">
																</div>
															</div>
														</div>
													</div>
