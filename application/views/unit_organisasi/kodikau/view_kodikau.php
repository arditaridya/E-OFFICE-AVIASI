                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo site_url('c_kesatuan/tambah_kodikau/'.$idmantra.'') ?>">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="sample_2">
                                        ...
                                        <tbody>
                                            <?php
                                            $no = 1;
                                            foreach ($list_kodikau as $data) {
                                                ?>
												<tr>
                                                    <td><?php echo $no; ?></td>
                                                    <td><!--<a href="<?php //echo site_url('c_kesatuan/kodikau2/'.$data->lanudId.''); ?>" target="_balnk">--><?php echo $data->lanudId; ?><!--</a>--></td>
                                                    <td> <a href="<?php echo site_url('data_aset/saveflag/'.$data->lanudId.'') ?>"><?php echo $data->lanud; ?></a></td>
                                                    <td>
                                                        <a href="<?php echo base_url() . "c_kesatuan/edit_kodikau/" . $data->lanudId; ?>" class="btn default btn-xs green">
                                                            <i class="fa fa-edit"></i> Edit 
														</a>
                                                        <a href="<?php echo base_url() . "c_kesatuan/delete_kodikau/" . $data->lanudId; ?>">
