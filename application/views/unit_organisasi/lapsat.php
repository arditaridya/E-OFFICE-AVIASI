                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
							...
							<li>
                                <a href="<?php echo site_url("c_kesatuan/laporan_perpangkalan/$idnya2") ?>">Laporan Per SATKER (<font color="blue"> <?php echo $namanya2; ?> </font>)</a>
                                
                                <i class="fa fa-angle-right"></i>
                            </li>
							<li>
                                <a href="<?php echo site_url("c_kesatuan/laporan_persatuan/$idnya") ?>"><b>Laporan Per Satuan</b> (<font color="blue"> <?php echo $namanya; ?> </font>)</a>
