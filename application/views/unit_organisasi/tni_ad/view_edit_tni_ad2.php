                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
							...
							<li>
								<?php foreach ($tni_ad_breadcrumb2 as $row) { ?>
                            ...
                            <div class="portlet box red">
                                <div class="portlet-title">
                                    <div class="caption">
                                        List Data Kesatuan
										<?php 
											foreach ($tni_ad_breadcrumb2 as $row){
												echo $row->kesatuan;
											} 
										?>
                                    </div>
                                ...
                                <div class="portlet-body">
                                    <!-- BEGIN FORM-->
									<?php foreach($tni_ad as $hole){ ?>
									<form action="<?php echo site_url('c_kesatuan/edit_tni_ad2/'.$idinduk.'/'.$id) ?>" class="horizontal-form" method = "post">
										<div class="form-body">
											<fieldset class="scheduler-border">
												<legend class="scheduler-border">
													TNI AD <i class="fa fa-angle-right"></i>
													<?php 
														foreach ($tni_ad_breadcrumb2 as $row){
															echo $row->kesatuan;
														} 
