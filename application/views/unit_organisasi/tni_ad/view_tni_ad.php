                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="#"><?php echo $idmantra; ?>-TNI AD</a>
                            </li>
                        </ul>
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo site_url('c_kesatuan/tambah_tni_ad/'.$idmantra.'') ?>">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="sample_2">
                                        ...
                                        <tbody>
                                            <?php
                                            $no = 1;
                                            foreach ($list_tni_ad as $data) {
                                                ?>
												<tr>
                                                    <td><?php echo $no; ?></td>
                                                    <td><a href="<?php echo site_url('c_kesatuan/tni_ad2/'.$data->id) ?>" target="_blank" ><?php echo $data->id; ?></a></td>
                                                    <td><?php echo $data->kesatuan; ?></td>
                                                    <td>
                                                        <a href="<?php echo base_url() . "c_kesatuan/edit_tni_ad/" . $data->id; ?>" class="btn default btn-xs green">
                                                            <i class="fa fa-edit"></i> Edit 
														</a>
                                                        <a href="<?php echo base_url() . "c_kesatuan/delete_tni_ad/" . $data->id; ?>">
