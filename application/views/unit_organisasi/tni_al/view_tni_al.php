                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo site_url('c_kesatuan/tambah_tni_al/'.$idmantra.'') ?>">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="sample_2">
                                        ...
                                        <tbody>
                                            <?php
                                            $no = 1;
                                            foreach ($list_tni_al as $data) {
                                                ?>
												<tr>
                                                    <td><?php echo $no; ?></td>
                                                    <td><a href="<?php echo site_url('c_kesatuan/tni_al2/'.$data->lanudId.''); ?>" target="_balnk"><?php echo $data->lanudId; ?></a></td>
                                                    <td><?php echo $data->lanud; ?></td>
                                                    <td>
                                                        <a href="<?php echo base_url() . "c_kesatuan/edit_tni_al/" . $data->lanudId; ?>" class="btn default btn-xs green">
                                                            <i class="fa fa-edit"></i> Edit 
														</a>
                                                        <a href="<?php echo base_url() . "c_kesatuan/delete_tni_al/" . $data->lanudId; ?>">
