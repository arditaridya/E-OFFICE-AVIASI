                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo site_url('c_kesatuan/tni_al/'.$id.''); ?>">TNI AL</a>
								<i class="fa fa-angle-right"></i>
                            </li>
							<li>
                                <a href="#">Edit Data</a>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box red">
                                ...
                                <div class="portlet-body">
                                    <!-- BEGIN FORM-->
									<?php foreach($tni_al as $row){ ?>
									<form action="<?php echo site_url('c_kesatuan/edit_tni_al/'.$row->id.'') ?>" class="horizontal-form" method = "post">
										<div class="form-body">
											<fieldset class="scheduler-border">
												<legend class="scheduler-border">TNI AL</legend>
												<div class="row">
													<div class="col-md-8">
