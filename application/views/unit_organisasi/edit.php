                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box blue">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="<?php echo base_url('c_kesatuan/updatelanud'); ?>" class="horizontal-form" method="post" enctype="multipart/form-data">
										...
										<div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-4">
                                                            <input type="text" class="form-control" name="lanud" id="lanud" value="<?php echo $data->lanud; ?>">
															<input type="hidden" class="form-control" name="idnya" id="idnya" value="<?php echo $data->id; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
										...
										<div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-4">
                                                            <input type="text" class="form-control" name="detillanud" id="detillanud" value="<?php echo $data->detillanud; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
										...
										<div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-4">
                                                            <input type="text" class="form-control" name="latitut" id="latitut" value="<?php echo $data->latitut; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
										...
										<div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-4">
                                                            <input type="text" class="form-control" name="longitut" id="longitut" value="<?php echo $data->longitut; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
