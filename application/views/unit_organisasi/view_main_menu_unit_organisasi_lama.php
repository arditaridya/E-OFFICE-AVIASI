...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>ASET TANAH | <?php echo $title ?></title>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <!-- BEGIN PAGE HEADER-->
                    <h3 class="page-title">
                        SELAMAT DATANG DI APLIKASI KESIAPAN ALUTSISTA
                    </h3>
                    <div class="page-bar">
                        ...
                        <?php if ($this->session->userdata('group_id') == 1 or $this->session->userdata('group_id') == 2) { ?>
                            <div class="col-lg-3 col-sm-6 col-xs-12">
                                <div class="dashboard-stat">
                                    <div class="details">
                                        <a class="more" href="<?php echo site_url('c_kesatuan/mabes_tni') ?>">
                                            <img src="<?php echo base_url() ?>assets/global/img/01.png" class="img-responsive" style="width: 200px; height: 198px">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-sm-6 col-xs-12">
                                <div class="dashboard-stat">
                                    <div class="details">
                                        <a class="more" href="<?php echo site_url('c_kesatuan/tni_ad') ?>">
                                            <img src="<?php echo base_url() ?>assets/global/img/02.png" class="img-responsive" style="width: 200px; height: 198px">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-sm-6 col-xs-12">
                                <div class="dashboard-stat">
                                    <div class="details">
                                        <a class="more" href="<?php echo site_url('c_kesatuan/tni_al') ?>">
                                            <img src="<?php echo base_url() ?>assets/global/img/03.png" class="img-responsive" style="width: 200px; height: 198px">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-sm-6 col-xs-12">
                                <div class="dashboard-stat">
                                    <div class="details">
                                        <a class="more" href="<?php echo site_url('c_kesatuan/tni_au') ?>">
                                            <img src="<?php echo base_url() ?>assets/global/img/04.png" class="img-responsive" style="width: 200px; height: 198px">
                                        </a>
                                    </div>
                                </div>
                            </div>
