                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box blue">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="<?php echo base_url('permasalahan/simpan'); ?>" class="horizontal-form" method="post" enctype="multipart/form-data">
										...
										<div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <label class="control-label col-md-3"><b>Upaya Penyelesaian</b></label>
                                                    <div class="form-group">
                                                        <div class="col-md-9">
                                                            <textarea class="form-control ckeditor" name="upaya_penyelesaian" id="upaya_penyelesaian"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
										...
										<div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <label class="control-label col-md-3"><b>Perkembangan Terakhir</b></label>
                                                    <div class="form-group">
                                                        <div class="col-md-9">
                                                            <textarea class="form-control ckeditor" name="perkembangan_terakhir" id="perkembangan_terakhir"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
