                                        ...
                                        <tbody>
                                            ...
                                            foreach ($model as $row) {
                                                ...
                                                <tr class="odd gradeX" bgcolor="#ccccff">
													...
													<td width="30%">
													<?php foreach ($grup_user as $low => $shop) { 
																 if($row->grup_user==$shop->id){
																echo $shop->nama;
																}
													} ?></td>
                                                    <td width="30%">
													<center>
                                                        <a href="<?php echo base_url('user/edit/' . $row->id . ''); ?>" class="btn btn-primary">
                                                            <i class="fa fa-pencil"></i> 
                                                        </a>
                                                        <a href="<?php echo site_url('user/hapus/' . $row->id . '') ?>">
