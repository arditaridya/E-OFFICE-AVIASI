                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box blue">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="<?php echo base_url('user/simpanedit'); ?>" class="horizontal-form" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-4">
															...
															<input type="hidden" class="form-control" name="idnya" id="idnya" value="<?php echo $row->id; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
										...
										<div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <label class="control-label col-md-3">Password Baru <br><font color="blue">( Isi Jika Ingin Ganti )</font></label>
                                                    <div class="form-group">
                                                        <div class="col-md-4">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-4">
                                                            <select class="form-control" name='grup_user' id='grup_user'>
																...
																<?php foreach($grup_user as $rew){ ?>
																<option value="<?php echo $rew->id; ?>" <?php echo ($row->grup_user == $rew->id)?"selected":""; ?>><?php echo $rew->nama; ?></option>
																<?php } ?>
															</select>
                                                        </div>
                                                    </div>
										...
										<div id="hidden1" <?php if($row->grup_user == 0 || $row->grup_user == 1 || $row->grup_user == 3){ ?> style="display: none;" <?php }else if($row->grup_user == 2){ ?> style="display: block;" <?php } ?>>
											<div class="row">
												<div class="col-md-8">
													<div class="form-group">
														...
														<div class="form-group">
															<div class="col-md-4">
																<select class="form-control" name='kotama' id='kotama' <!--onchange='getLad()' -->>
																	...
																	<?php foreach($kotama as $rew){ ?>
																	<option value="<?php echo $rew->id; ?>" <?php echo ($row->kotama == $rew->id)?"selected":""; ?>><?php echo $rew->kotama; ?></option>
																	<?php } ?>
																</select>
															</div>
														</div>
										...
										<div id="hidden2" <?php if($row->grup_user == 0 || $row->grup_user == 1 || $row->grup_user == 2){ ?> style="display: none;" <?php }else if($row->grup_user == 3){ ?> style="display: block;" <?php } ?>>
											<div class="row">
												<div class="col-md-8">
													<div class="form-group">
														<label class="control-label col-md-3">Kotama</label>
														...
														<div class="form-group">
															<div class="col-md-4">
																...
																<select class="form-control" name='lanud2' id='lanud2'>
																	...
																	<?php foreach($lanudzx as $rew){ ?>
																	<option value="<?php echo $rew->id; ?>" <?php echo ($row->lanud == $rew->id)?"selected":""; ?>><?php echo $rew->lanud; ?></option>
																	<?php } ?>
																</select>
																</div>
															</div>
