                ...
                <div class="page-content">
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            <li>
                                ...
                                <a href="<?php echo site_url('c_master/jenis_kesatuan') ?>">Alutsista TNI AU</a>
                    ...
                    <div class="portlet box green" id="form-organisasi">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo site_url('c_master/simpan_jenis_kesatuan') ?>" class="horizontal-form" method = "post">
                                <div class="form-body">
                                    <fieldset class="scheduler-border">
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-5">
														<input type="text" name="jenis_kesatuan" class="form-control">
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
										...
										<div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <label class="control-label col-md-3" for="program">Urutan</label>
                                                    <div class="form-group">
                                                        <div class="col-md-5">
