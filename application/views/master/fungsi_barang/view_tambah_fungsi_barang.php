                ...
                <div class="page-content">
                    ...
                    <div class="portlet box red" id="form-organisasi">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo site_url('c_master/tambah_fungsi_barang') ?>" class="horizontal-form" method = "post">
                                <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-5" id="kode" >
                                                               <input type="text" id="kode2" name="kode" onkeyup="myFunction('kode2');" class="form-control" disabled >
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
										...
										<div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-5">
                                                               <input type="text" name="FUNGSI_BARANG" id="fungsi" onkeyup="myFunction('fungsi');" class="form-control">
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
