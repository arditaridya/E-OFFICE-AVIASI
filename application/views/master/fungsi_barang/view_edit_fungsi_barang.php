        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <h3 class="page-title">
                        Edit Data Master Fungsi Barang                    
                    </h3>
                    <div class="portlet box red" id="form-organisasi">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
							<?php foreach($fungsi_barang as $row) { ?>
                            <form action="<?php echo site_url('c_master/edit_fungsi_barang/'.$row->id.'') ?>" class="horizontal-form" method = "post">
                                <div class="form-body">
                                    <fieldset class="scheduler-border">
                                        <legend class="scheduler-border">Fungsi Barang</legend>
                                        <!--<div class="row">
											<div class="col-md-8">
										...
										<div class="row">
											<div class="col-md-8">
												<div class="form-group">
													...
													<div class="form-group">
														<div class="col-md-5">
															<select class="form-control select2me" id="jenis" name="JENIS" disabled url="<?php echo site_url('c_master/get_kodjen'); ?>" >
										...
										<div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <label class="control-label col-md-3" for="program">Kode Fungsi Barang</label>
                                                    <div class="form-group">
                                                        <div class="col-md-5" id="kode" >
                                                               <input type="text" id="kode2" name="kode" value="<?php echo $row->kode; ?>" class="form-control" disabled >
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
										...
										<div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <label class="control-label col-md-3" for="program">Fungsi Barang</label>
                                                    <div class="form-group">
                                                        <div class="col-md-5">
                                                               <input type="text" name="FUNGSI_BARANG" id="fungsi" value="<?php echo $row->fungsi; ?>" onkeyup="myFunction('fungsi');" class="form-control">
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
