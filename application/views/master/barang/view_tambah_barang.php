                ...
                <div class="page-content">
                    ...
                    <div class="portlet box red" id="form-organisasi">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo site_url('c_master/tambah_barang') ?>" class="horizontal-form" method = "post">
                                <div class="form-body">
										...
										<div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-5">
                                                               <input type="text" name="BARANG" id="barang" onkeyup="myFunction('barang');" class="form-control">
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
										...
										<div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-5">
                                                               <input type="text" name="NEGARA_ASAL" id="negara_asal" onkeyup="myFunction('negara_asal');" class="form-control">
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
										...
										<div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-5">
                                                               <input type="text" name="TAHUN_BUAT" id="tahun_buat" onkeyup="myFunction('tahun_buat');" class="form-control">
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
