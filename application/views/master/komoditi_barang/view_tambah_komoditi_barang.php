                ...
                <div class="page-content">
                    ...
                    <div class="portlet box red" id="form-organisasi">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo site_url('c_master/tambah_komoditi_barang') ?>" class="horizontal-form" method = "post">
                                <div class="form-body">
                                        ...
                                        <div class="row">
											<div class="col-md-8">
												<div class="form-group">
													...
													<div class="form-group">
														<div class="col-md-5">
																<?php echo form_dropdown('MATRA',$get_matra, '','class="form-control" id="matra" onChange="getMatra(this)"'); ?>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-5">
                                                               <input type="text" name="KOMODITI_BARANG" id="komoditi_barang" onkeyup="myFunction('komoditi_barang');" class="form-control" placeholder="Komoditi Barang...">
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
