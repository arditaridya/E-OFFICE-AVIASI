						...
						<div id="cetak" style="display:none;">
							<div class="row">
								<div class="form-group">
									<label class="col-md-1">Kesatuan</label>
									<div class="col-md-3">
											<?php echo form_dropdown('MATRA',$get_matra, '','class="form-control"'); ?>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="control-group">
								<div class="form-actions left">
									<button type="submit" name="CARI" class="btn green"><i class="fa fa-search"></i> Cari</button>
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo site_url('c_master/tambah_komoditi_barang') ?>">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="sample_4">
                                        ...
                                        <tbody>
                                            <?php
                                            $no = 1;
                                            foreach ($komoditi_barang as $data) {
                                                ?>
                                                <tr class="odd gradeX">
                                                    <td><?php echo $no; ?></td>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url() . "c_master/edit_komoditi_barang/" . $data->id; ?>" class="btn default btn-xs green">
                                                            <i class="fa fa-edit"></i> Edit </a>
                                                        <a href="<?php echo base_url() . "c_master/delete_komoditi_barang/" . $data->id; ?>">
