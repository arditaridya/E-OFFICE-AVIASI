                ...
                <div class="page-content">
                    ...
                    <div class="portlet box red" id="form-organisasi">
                        ...
                        <div class="portlet-body form">
                            ...
                            <form action="<?php echo site_url('c_master/edit_jenis_barang/'.$row->id.'') ?>" class="horizontal-form" method = "post">
                                <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-5" id="kode">
                                                               <input type="text" id="kode2" value="<?php echo $row->kode; ?>" class="form-control" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
										...
										<div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-5">
                                                               <input type="text" name="JENIS_BARANG" id="jenis_barang" value="<?php echo $row->jenis; ?>" onkeyup="myFunction('jenis_barang');" class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
