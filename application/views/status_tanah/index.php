                                        ...
                                        <tbody>
                                            ...
                                            foreach ($model as $row) {
                                                ...
                                                <tr class="odd gradeX" bgcolor="#ccccff">
													...
													<center>
                                                        <a href="<?php echo base_url('status_tanah/edit/' . $row->id . ''); ?>" class="btn btn-primary">
                                                            <i class="fa fa-edit"></i>
                                                        </a>
                                                        <a href="<?php echo site_url('status_tanah/hapus/' . $row->id . '') ?>">
