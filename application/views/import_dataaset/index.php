...
<form action="<?php echo base_url();?>import_dataaset/upload/" method="post" enctype="multipart/form-data">
...
function getXMLHTTP(){
	...
	function getSat() {
		...
		var strURL = "<?php echo base_url();?>import_dataaset/getsatker";
