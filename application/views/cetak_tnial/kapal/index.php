                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo site_url('cetak_tnial/lap_kapal_al'); ?>">Kapal</a>
                            </li>
                        </ul>
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo site_url('cetak_tnial/cetakkapalall') ?>" target="_blank">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="sample_14">
                                        <thead>
                                            <tr>
												...
												<th colspan="2">TINGKATAN KESIAPAN</th>
