                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo site_url('cetak_tnial/lap_ranpur_al'); ?>">Ranpur</a>
                                <i class="fa fa-angle-right"></i>
                            </li>
                        </ul>
                                ...
                                <div class="portlet-body">
									<div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo site_url('cetak_tnial/cetak_ranpur_al') ?>" target="_blank">
									...
									<table class="table table-striped table-bordered table-hover" id="sample_2">
										...
										<tbody>
											<?php 
												$no=1;
												foreach($data_ranpur_al as $hasil){ 
											?>
											<tr>
												<td><?php echo $no; ?></td>
												...
												<!--<td>
													<a href="<?php echo base_url() .'c_alutsista/edit_ranpur_ad/'. $hasil->id; ?>" class="btn default btn-xs green">
														<i class="fa fa-edit"></i> Edit 
													</a>
													<a href="<?php echo base_url().'c_alutsista/delete_ranpur_ad/'. $hasil->id; ?>">
