                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
								...
								?>
                                <a href="<?php echo site_url('permasalahan/index/'.$link); ?>">List Permasalahan (<font color="blue"> <?php echo $nama_lanud;?> </font>)</a>
...
?>
                                    <form action="<?php echo base_url('permasalahan/update/'.$this->uri->segment(3)); ?>" class="horizontal-form" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-5">
                                                            <select class="form-control" name='provinsi' id='provinsi' onchange='getKab()'>
																...
																<option value="<?php echo $row->nama_provinsi; ?>" <?php echo ($value->provinsi == $row->nama_provinsi)?"selected":""; ?>><?php echo $row->nama_provinsi; ?></option>
																<?php } ?>
															</select>
                                                        </div>
                                                    </div>
										...
										<div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-5">
                                                            <textarea class="form-control" name="alamat" id="alamat"><?php echo $value->alamat; ?> </textarea>
										...
										<div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-8">
                                                            <textarea class="form-control ckeditor" name="permasalahan" id="permasalahan"><?php echo $value->permasalahan; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
										...
										<div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <label class="control-label col-md-3">Hasil Klarifikasi</label>
                                                    <div class="form-group">
                                                        <div class="col-md-8">
                                                            <textarea class="form-control ckeditor" name="hasil_klarifikasi" id="hasil_klarifikasi"><?php echo $value->hasil_klarifikasi; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
										...
										<div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-8">
                                                            <textarea class="form-control ckeditor" name="tindak_lanjut" id="tindak_lanjut"><?php echo $value->tindak_lanjut; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
