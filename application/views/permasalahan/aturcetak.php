                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box blue">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="<?php echo base_url('permasalahan/cetakdataaset/'.$this->uri->segment(3)); ?>" class="horizontal-form" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-actions left">
											...
											<a href="<?php echo base_url('permasalahan/getword/'.$this->uri->segment(3)); ?>" class="btn blue"><i class="fa fa-file-word-o">&nbsp;  Word</i> </a>
...
function getXMLHTTP(){
	...
	function getFrame() {
		...
		var strURL = "<?php echo base_url();?>permasalahan/getform";
		...
		if (req) {
			...
			req.open("GET", strURL+ "?urinya=" + urinya + "&&pow1=" + pow1 + "&&pow2=" + pow2 + "&&pow3=" + pow3, true);
	...
	function getWord() {
		...
		var strURL = "<?php echo base_url();?>permasalahan/getword";
		var urinya = document.getElementById('urinya').value;
		var ttc = document.getElementById('ttc').value;
		var penanggungjwb = document.getElementById('penanggungjwb').value;
		var judul = document.getElementById('judul').value;
		...
		if (req) {
			...
			req.open("GET", strURL+ "?urinya=" + urinya + "&&ttc=" + ttc + "&&penanggungjwb=" + penanggungjwb + "&&judul=" + judul, true);
			//req.open("GET", strURL + "/" + provinsi, true);
			req.send(null);
		}
