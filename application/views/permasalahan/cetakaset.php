...
<table border="1" cellspacing="0" cellpadding="0" width="100%" id="tab1" repeat_header="1">
	<thead>
		<tr align = "center">
			...
			<th align="center">Permasalahan</th>
			<th align="center">Hasil Klarifikasi</th>
	...
	foreach ($jojo as $key => $value) {
		...
		$html .= '
			...
			<tr align = "center">
				...
				<td width="15%"><center>'.$value->provinsi.'<br>'.$value->alamat.'</center></td>
				<td width="10%">&nbsp;&nbsp;'.$value->nilai.'</td>
				<td width="10%">&nbsp;&nbsp;'.$value->luas.'</td>
				<td width="20%">'.$value->permasalahan.'</td>
				<td width="20%">'.$value->hasil_klarifikasi.'</td>
				<td width="20%">'.$value->tindak_lanjut.'</td>
			</tr>
...
//$mpdf->setHTMLFooter('<div align="right">sdfsdfgdfgdf</div>');
