                                        ...
                                        <tbody>
                                           ...
                                           foreach ($datanyax as $row) {
											   $zakzak = $row->id; 
                                                ?>
                                                <tr class="odd gradeX" >
                                                    <td width="6%" align="center"><?php  // echo $no; ?></td>
												...
												<tr class="odd gradeX" >
												<?php $zukzuk2 = $rpw->id; ?>
                                                    <td width="6%" align="center"><?php // echo $noz; ?></td>
...
<?php												
												...
												foreach ($queryaset as $rzw) {
													...
													<td>
														<?php 
														$daper = $rzw->dasar_perolehan;
													
														$querypopo = $this->db->query("
																								SELECT * 
																								FROM 
																									dasar_perolehan 
																								WHERE
																					...
																					foreach ($querypopo as $rtk)
																							{
																							$pumow = $rtk->dasar_perolehan;
													...
													<td><?php echo number_format($rzw->nilai, 0, "," , "."); ?></td>
													<td width ="10%"><?php echo $rzw->permasalahan; ?></td>
													<td><?php echo $rzw->keterangan; ?></td>
													<td></td>
