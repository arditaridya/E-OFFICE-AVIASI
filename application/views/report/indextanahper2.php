                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="#">Data Tanah Per Satker</a>
                            </li>
                        </ul>
...
function Hapusnya(a){
		...
		var strURL = "<?php echo base_url();?>report/preview_aset";
	...
	function getDaz2() {
		...
		var strURL = "<?php echo base_url();?>report/preview_aset2";
		var jela = document.getElementById('jela').value;
		var kotama = document.getElementById('kotama').value;
		var ttc = document.getElementById('ttc').value;
		var penanggungjwb = document.getElementById('penanggungjwb').value;
		...
		if(kotama == 0){
			...
			window.location = "<?php echo base_url();?>report/data_aset";
		}else{
			var powkot = kotama;
			//alert(powkot)
		}
	...
	function getDaz3() {
		...
		var strURL = "<?php echo base_url();?>report/preview_tanper2";
		var kotama2 = document.getElementById('kotama2').value;
		...
		if(kotama2 == 0){
			alert("Mohon Kotama Diisi, Dikarenakan Jenis Laporan Memiilih Per Kotama")
			window.location = "<?php echo base_url();?>report/data_tanah_per2";
		}else{
			var powkot = kotama2;
			//alert(powkot)
		}
		...
		if (req) {
			...
			req.open("GET", strURL+ "?pow1=" + pow1 + "&&powkot=" + powkot + "&&powkot2=" + powkot2 + "&&pow2=" + pow2 + "&&pow3=" + pow3 + "&&pow4=" + pow4 + "&&pow5=" + pow5, true);
			//req.open("GET", strURL + "/" + provinsi, true);
			req.send(null);
		}
