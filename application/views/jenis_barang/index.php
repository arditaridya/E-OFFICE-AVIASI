                                ...
                                <div class="portlet-body" style="background-color:#99ccff;">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo site_url('jenis_barang/tambahjenisbarang') ?>">
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-responsive" id="sample_4">
                                        <thead>
                                            <tr bgcolor="#ccccff">
												...
												<th><center>Nama Jenis Barang</center></th>
                                                ...
                                                <tr class="odd gradeX" bgcolor="#ccccff">
                                                   ...
                                                   <td width="30%"><textarea cols="40" rows="3" readonly><?php $zaz = str_replace("<p>","",$row->keterangan); $xaz = str_replace("</p>","",$zaz); echo $xaz; ?></textarea></td>
                                                    ...
                                                    <td width="15%" align="center">
                                                        <a href="<?php echo base_url('jenis_barang/editjenisbarang/' . $row->id_jenisbarang . ''); ?>" class="btn btn-primary">
                                                            <i class="fa fa-edit"> Edit</i>
                                                        </a>
                                                        <a href="<?php echo site_url('jenis_barang/hapus/' . $row->id_jenisbarang . '') ?>">
