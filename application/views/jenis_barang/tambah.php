                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box blue">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="<?php echo base_url('jenis_barang/simpanjenisbarang'); ?>" class="horizontal-form" method="post">
										...
										<div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-6">
                                                            <input type="text" class="form-control" name="nama_jenisbarang" id="nama_jenisbarang">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
