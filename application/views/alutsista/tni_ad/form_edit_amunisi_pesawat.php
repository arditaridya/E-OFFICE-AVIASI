                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo site_url('c_alutsista/view_amunisi_pesawat_ad'); ?>">Amunisi Pesawat</a>
								<i class="fa fa-angle-right"></i>
                            </li>
							<li>
                                Edit Data
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box red">
                                ...
                                <div class="portlet-body form">
									<!-- BEGIN FORM-->
									<?php foreach($amunisi_pesawat_ad as $rows){ ?>
									<form action="<?php echo base_url('c_alutsista/edit_amunisi_pesawat_ad/'.$rows->id.''); ?>" class="horizontal-form" method="post">
                                    	<div class="row">
                                            <div class="col-md-8">
