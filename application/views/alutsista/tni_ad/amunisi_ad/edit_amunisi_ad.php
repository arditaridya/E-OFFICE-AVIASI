                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box red">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form method="POST" class="horizontal-form" action="<?php echo site_url('c_alutsista/proses_edit_amunisi_ad/' . $this->uri->segment(3)); ?>">
                                     <div class="form-body">
									 <div class="row">
										<div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                 <table id="tabel_fasilitas" class="table table-striped table-bordered table-hover table-full-width">
																...
																<tbody>
                                                                        <?php
                                                                        $i = 0;
                                                                        foreach ($detail_amunisi_ad as $val) {
                                                                            $i++;
                                                                            ?>
                                                                            <!-- update dari tabel -->
                                                                            <tr>
																				...
																				<td>
                                                                                    <input type="text" name="PERSEDIAAN_DAERAH[]" class="form-control" value="<?php echo $val->persediaan_daerah; ?>"/>
                                                                                </td>
																				<td>
...
<?php } ?>\n\
		...
		var PERSEDIAAN_SATUAN  	= '<input class="form-control" type="text" name="PERSEDIAAN_SATUAN[]">';
		var PERSEDIAAN_DAERAH 	= '<input class="form-control" type="text" name="PERSEDIAAN_DAERAH[]">';
