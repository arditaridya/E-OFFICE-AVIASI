        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <h3 class="page-title">
                        Edit Data Aloptik AD                    
                    </h3>
                    <div class="portlet box red" id="form-organisasi">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i>Form Edit Aloptik AD
                            </div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form">
                            <?php foreach ($aloptik as $data) { ?>
                                <!-- BEGIN FORM-->
                                <form action="<?php echo site_url('c_alutsista/edit_aloptik_ad/' . $this->uri->segment(3)); ?>" class="horizontal-form" method = "post">
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-8">
