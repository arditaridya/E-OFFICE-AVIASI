                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                           <li>
                            ...
                            <li>
                                <a href="<?php echo site_url('c_alutsista/aloptik_ad'); ?>">Aloptik</a>
                            </li>
                        </ul>
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo site_url('c_alutsista/form_aloptik_ad') ?>">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($list_aloptik as $data) {
                                                ...
                                                <tr class="odd gradeX" onclick="">
                                                    ...
                                                    <td>
                                                        <?php
                                                            foreach ($jenis_aloptik as $jenis_res) {
                                                    ...
                                                    <td>
                                                        <?php
                                                            foreach ($fungsi_aloptik as $fungsi_res) {
                                                    ...
                                                    <td>
                                                        <?php
                                                            foreach ($barang_aloptik as $barang_res) {
                                                    ...
                                                    <!-- <td>
                                                        <?php
                                                            echo $data->b_gudang_1;
                                                        ?>
                                                    </td>
                                                    <td>
                                                        <?php
                                                            echo $data->b_gudang_2;
                                                        ?>
                                                    </td>
                                                    <td>
                                                        <?php
                                                            echo $data->rr_gudang_1;
                                                        ?>
                                                    </td>
                                                    <td>
                                                        <?php
                                                            echo $data->rr_gudang_2;
                                                        ?>
                                                    </td>
                                                    <td>
                                                        <?php
                                                            echo $data->rb_gudang_1;
                                                        ?>
                                                    </td>
                                                    <td>
                                                        <?php
                                                            echo $data->rb_gudang_2;
                                                        ?>
                                                    </td> -->
                                                    <td>
                                                        <?php
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url() . "c_alutsista/edit_aloptik_ad/" . $data->id; ?>" class="btn default btn-xs green">
                                                            <i class="fa fa-edit"></i> Edit </a>
                                                        <a href="<?php echo base_url() . "c_alutsista/hapus_aloptik_ad/" . $data->id; ?>">
