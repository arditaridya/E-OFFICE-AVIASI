                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo site_url('c_alutsista/form_senjata_ad') ?>"><button id="sample_editable_1_new" class="btn blue">
                                                            Tambah Baru <i class="fa fa-plus"></i>
                                                        </button></a>
                                                    <!-- <a href="<?php echo site_url('cetak_tniad/cetaksenjataad') ?>"><button id="sample_editable_1_new" class="btn red">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($list_senjata as $data) {
                                                ...
                                                <tr class="odd gradeX" onclick="">
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url() . "c_alutsista/edit_senjata_ad/" . $data->id; ?>" class="btn default btn-xs green">
                                                            <i class="fa fa-edit"></i> Edit </a>
                                                        <a href="<?php echo base_url() . "c_alutsista/hapus_senjata_ad/" . $data->id; ?>">
