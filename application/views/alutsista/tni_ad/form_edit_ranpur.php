                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo site_url('c_alutsista/view_ranpur_ad'); ?>">Ranpur</a>
								<i class="fa fa-angle-right"></i>
                            </li>
							<li>
                                Edit Data
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box red">
                                ...
                                <div class="portlet-body form">
									<!-- BEGIN FORM-->
									<?php foreach($ranpur_ad as $rows){ ?>
									<form action="<?php echo site_url('c_alutsista/edit_ranpur_ad/'.$rows->id.''); ?>" class="horizontal-form" method="post">
										<div class="row">
                                            <div class="col-md-8">
                                        ...
                                        <div class="row">
											<div class="col-md-8">
												 <div class="form-group">
													<label class="control-label col-md-3"><strong>Operasional</strong></label>
													<div class="form-group">
                                                        <div class="col-md-8">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <label class="control-label col-md-3">Siap</label>
													 <div class="form-group">
                                                        <div class="col-md-8">
                                                            <input type="text" class="form-control" value="<?php echo $rows->s_op; ?>" name="s" id="s">
                                                        </div>
                                                    </div>
												</div>
											</div>
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <label class="control-label col-md-3">Tidak Siap</label>
													 <div class="form-group">
                                                        <div class="col-md-8">
                                                            <input type="text" class="form-control" value="<?php echo $rows->ts_op; ?>" name="ts" id="ts">
                                                        </div>
                                                    </div>
												</div>
											</div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <label class="control-label col-md-3"><strong>Non Operasional</strong></label>
													 <div class="form-group">
                                                        <div class="col-md-8">
										...
										<div class="row">
											<div class="col-md-8">
												 <div class="form-group">
													...
													<div class="form-group">
                                                        <div class="col-md-8">
                                                            <input type="text" class="form-control" value="<?php echo $rows->kons_nop; ?>" name="kons" id="kons">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
										...
										<div class="row">
											<div class="col-md-8">
												 <div class="form-group">
													...
													<div class="form-group">
                                                        <div class="col-md-8">
                                                            <input type="text" class="form-control" value="<?php echo $rows->rb_nop; ?>" name="rb" id="rb">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
											<div class="col-md-8">
												 <div class="form-group">
													...
													<div class="form-group">
                                                        <div class="col-md-8">
                                                            <input type="text" class="form-control" value="<?php echo $rows->tl_nop; ?>" name="tl" id="tl">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
