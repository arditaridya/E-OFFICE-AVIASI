                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box red">
                                ...
                                <div class="portlet-body form">
									...
									<form action="<?php echo base_url('c_alutsista/simpan_tambah_ranpur_ad'); ?>" class="horizontal-form" method="post">
										<div class="row">
                                            <div class="col-md-8">
										...
										<div class="row">
											<div class="col-md-8">
												 <div class="form-group">
													...
													<div class="form-group">
                                                        <div class="col-md-8">
                                                            <input type="text" class="form-control" name="kons" id="kons">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
