                                            ...
                                            foreach ($amunisi_al as $data) {
                                                ...
                                                <tr class="odd gradeX" >
                                                   ...
                                                   <td>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url() . "c_alutsista/edit_amunisi_al/" . $data->id; ?>" class="btn default btn-xs green">
                                                            <i class="fa fa-edit"></i> Edit 
														</a>
                                                        <a href="<?php echo base_url() . "c_alutsista/hapus_amunisi_al/" . $data->id; ?>">
