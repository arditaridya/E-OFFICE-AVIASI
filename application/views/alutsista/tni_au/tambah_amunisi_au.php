                ...
                <div class="page-content">
                    ...
                    <div class="portlet box red" id="form-organisasi">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo site_url('c_alutsista/tambah_amunisi_au') ?>" class="horizontal-form" method = "post">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-8">
									...
									<div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-5">
                                                        <input type="text" name="pakai" id="pakai" class="form-control" placeholder="Gunakan 1 Bulan">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
