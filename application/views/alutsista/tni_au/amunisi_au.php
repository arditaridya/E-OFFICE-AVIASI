                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo site_url('c_alutsista/tambah_amunisi_au') ?>">
                                    ...
                                    ?>
                                    <table class="table table-striped table-bordered table-hover" id="sample_3" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th>
                                                    No
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($amunisi_au as $data) {
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url() . "c_alutsista/edit_amunisi_au/" . $data->id; ?>" class="btn default btn-xs green">
                                                            <i class="fa fa-edit"></i> Edit </a>
                                                        <a href="<?php echo base_url() . "c_alutsista/hapus_amunisi_au/" . $data->id; ?>">
