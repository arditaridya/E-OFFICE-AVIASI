                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo site_url('c_alutsista/tambah_pesawat_au') ?>">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($pesawat_au as $data) {
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url() . "c_alutsista/edit_pesawat_au/" . $data->id; ?>" class="btn default btn-xs green">
                                                            <i class="fa fa-edit"></i> Edit </a>
                                                        <a href="<?php echo base_url() . "c_alutsista/hapus_pesawat_au/" . $data->id; ?>">
