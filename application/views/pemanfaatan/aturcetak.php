                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box blue">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="<?php echo base_url('pemanfaatan/cetakdataaset/'.$this->uri->segment(3)); ?>" class="horizontal-form" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-actions left">
                                            ...
                                            <!--<button type="button" class="btn yellow" onclick=self.history.back()><i class="fa fa-undo"></i> Batal</button>-->
											<a href="<?php echo base_url('pemanfaatan/getword/'.$this->uri->segment(3)); ?>" class="btn blue"><i class="fa fa-file-word-o">&nbsp;  Word</i> </a>
...
function getFrame() {
		...
		var strURL = "<?php echo base_url();?>pemanfaatan/getform";
