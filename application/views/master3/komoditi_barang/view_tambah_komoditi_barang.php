                ...
                <div class="page-content">
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            <li>
                                ...
                                <a href="<?php echo site_url('c_master/komoditi_barang') ?>">Alutsista</a>
                    ...
                    <div class="portlet box green" id="form-organisasi">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo site_url('c_master/simpan_komoditi_barang') ?>" class="horizontal-form" method = "post">
                                <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-5">
														<input type="text" name="kelompok_barang_kode" class="form-control">
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
