                ...
                <div class="page-content">
                    ...
                    <div class="portlet box green" id="form-organisasi">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo site_url('c_master/simpan_jenis_barang') ?>" class="horizontal-form" method = "post">
                                <div class="form-body">
										...
										<div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-5">
                                                               <input type="text" name="komoditi_barang_kode" class="form-control">
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
