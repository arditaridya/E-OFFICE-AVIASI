                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box red">
                                ...
                                <div class="portlet-body form">
									...
									<form action="
									<?php if ($this->uri->segment(1) == 'sdm') { ?>
										<?php echo base_url('sdm/tambah_provinsi'); ?>
									<?php } elseif ($this->uri->segment(1) == 'sdab') { ?>
										<?php echo base_url('sdab/tambah_provinsi'); ?>
									<?php } elseif ($this->uri->segment(1) == 'saprana') { ?>
										<?php echo base_url('saprana/tambah_provinsi'); ?>
									<?php } ?>
