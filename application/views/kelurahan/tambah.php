                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo site_url('kelurahan'); ?>">List Kelurahan</a>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box blue">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="<?php echo base_url('kelurahan/simpankelurahan'); ?>" class="horizontal-form" method="post">
...
function getXMLHTTP(){
	...
	function getKab() {
		...
		var strURL = "<?php echo base_url();?>kelurahan/getkabupaten";
