                                ...
                                <div class="portlet-body" style="background-color:#99ccff;">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo site_url('kelurahan/tambahkelurahan') ?>">
                                            ...
                                            foreach ($model as $row) {
                                                ...
                                                <tr class="odd gradeX" bgcolor="#ccccff">
                                                    ...
                                                    <td width="15%" align="center">
                                                        <a href="<?php echo base_url('kelurahan/editkelurahan/' . $row->id_kelurahan . ''); ?>" class="btn btn-primary">
                                                            <i class="fa fa-pencil"></i> 
                                                        </a>
                                                        <a href="<?php echo site_url('kelurahan/hapus/' . $row->id_kelurahan . '') ?>">
