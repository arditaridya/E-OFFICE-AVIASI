                                  ...
                                  <!-- 
								   <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php // echo site_url('status_tanah/tambah') ?>">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($model as $row) {
                                                ...
                                                <tr class="odd gradeX" bgcolor="#ccccff">
													...
													<td width="15%">
													<center>
													<img src="<?php echo base_url() ?>assets/upload/kotama/<?php echo $row->photo; ?>" class="img-responsive" style="width: 90px; height: 94px"></td>
													</center>
													<td width="30%"><center><?php echo $row->kotama; ?></center></td>
                                                    <td width="30%"><center><?php echo $row->detilkotama; ?></center></td>
                                                    <td width="15%">
													<center>
                                                        <a href="<?php echo base_url('kotama/edit/' . $row->id . ''); ?>" class="btn btn-primary">
                                                            <i class="fa fa-pencil"></i> 
                                                        </a>
                                                        <a href="<?php echo site_url('kotama/hapus/' . $row->id . '') ?>">
