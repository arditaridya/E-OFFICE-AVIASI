                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo site_url('kabupaten'); ?>">List Kabupaten</a>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box blue">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="<?php echo base_url('kabupaten/simpanedit'); ?>" class="horizontal-form" method="post">
...
<?php foreach($dataper as $value){ ?>
										...
										<div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <label class="control-label col-md-3">Nama Kabupaten</label>
                                                    <div class="form-group">
                                                        <div class="col-md-3">
                                                            <input type="text" class="form-control" name="nama_kabupaten" id="nama_kabupaten" value="<?php echo $value->nama_kabupaten;?>">
