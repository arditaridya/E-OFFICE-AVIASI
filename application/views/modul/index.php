                                ...
                                <div class="portlet-body" style="background-color:#99ccff;">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo site_url('modul/tambah') ?>">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($model as $row) {
                                                ...
                                                <tr class="odd gradeX" bgcolor="#ccccff">
                                                    ...
                                                    <td width="25%"><?php echo $row->nama_modul; ?></td>
													<td width="25%"><?php echo $row->parent; ?></td>
													<td width="25%"><?php echo $row->url; ?></td>
                                                    <td width="15%">
													<center>
                                                        <a href="<?php echo base_url('modul/edit/' . $row->id . ''); ?>" class="btn btn-primary">
                                                            <i class="fa fa-pencil"></i>
                                                        </a>
                                                        <a href="<?php echo site_url('modul/hapus/' . $row->id . '') ?>">
