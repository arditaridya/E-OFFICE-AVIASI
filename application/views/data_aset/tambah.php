                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="<?php echo base_url('data_aset/simpan/'.$this->uri->segment(3)); ?>" class="horizontal-form" method="post" enctype="multipart/form-data">
										...
										<div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <label class="control-label col-md-3"><font color="red">*</font> IKN</label>
                                                    <div class="form-group">
                                                        <div class="col-md-5">
										...
										<div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <label class="control-label col-md-3"><font color="red">*</font> SIMAK</label>
                                                    <div class="form-group">
                                                        <div class="col-md-5">
                                                            <input type="text" class="form-control" name="simak" id="simak" maxlength="14">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
										...
										<div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <label class="control-label col-md-3"><font color="red">*</font> Luas</label>
                                                    <div class="form-group">
                                                        <div class="col-md-5">
                                                            <input type="text" class="form-control" name="luas" id="luas" onkeypress="return hanyaAngka(event, false)" onkeyup="calculate1()">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
										...
										<div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <label class="control-label col-md-3"><font color="red">*</font> Status Tanah</label>
                                                    <div class="form-group">
                                                        <div class="col-md-5">
                                                            <select class="form-control" name='status_tanah' id='status_tanah'>
																...
																<option value="<?php echo $row->id; ?>"><?php echo $row->status_tanah; ?></option>
																<?php } ?>
															</select>
                                                        </div>
                                                    </div>
										...
										<div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <label class="control-label col-md-3"><font color="red">*</font> Dasar Perolehan</label>
                                                    <div class="form-group">
                                                        <div class="col-md-5">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-5">
                                                            <select class="form-control" name='keadaan_tanah' id='keadaan_tanah'>
																...
																<option value='2'>Tidak Bermasalah</option>
															</select>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-5">
															...
															<input type="text" class="form-control" name="tahun_perolehan" id="tahun_perolehan" maxlength="4">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
										...
										<div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-5">
															<input type="text" class="form-control" name="peruntukan" id="peruntukan">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
										...
										<div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <label class="control-label col-md-3"><font color="red">*</font> No Sertifikat</label>
                                                    <div class="form-group">
                                                        <div class="col-md-5">
										...
										<div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-5">
                                                            <input type="text" class="form-control" name="sert_luas" id="sert_luass" onkeypress="return hanyaAngka(event, false)" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
										...
										<div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <label class="control-label col-md-3"><font color="red">*</font> Nilai</label>
                                                    <div class="form-group">
                                                        <div class="col-md-5">
                                                            <input type="text" class="form-control" name="nilai" id="nilai" onkeyup="actNumber(this.value)"  onkeypress="return hanyaAngka(event, false)">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
