                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo site_url('aset_tanah/tambahpermasalahan'); ?>">
                                           ...
                                           foreach ($datanya as $row) {
                                                ...
                                                <tr class="odd gradeX" >
													...
													<center>
                                                        ...
                                                        <a href="<?php echo base_url('permasalahan/edit/'.$row->idper); ?>" class="btn default btn-xs green">
                                                            <i class="fa fa-edit"></i> Edit 
                                                        </a>
                                                        <a href="<?php echo site_url('aset_tanah/hapuspermasalahan/'.$row->idper); ?>">
