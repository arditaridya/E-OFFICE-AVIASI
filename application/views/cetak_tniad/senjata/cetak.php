	...
	<table border="1" cellspacing="0" cellpadding="0" width="100%" id="tab1" repeat_header="1">
		...
		$html .='
			...
			<tr>
				...
				$fungsi=mysql_query("SELECT * FROM senjata_ad a, fungsi_barang b where a.id_jenis=$id_jeniss AND a.id_fungsi=b.id group by id_fungsi");
				...
				<tr>
					...
					';
					$brg=mysql_query("SELECT * FROM senjata_ad a, barang b where a.id_fungsi=$id_fun AND a.id_barang=b.id group by id_barang ");
