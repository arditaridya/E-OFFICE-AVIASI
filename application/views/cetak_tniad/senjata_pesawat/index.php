                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo site_url('cetak_tniad/lap_senjata_pesawat_ad'); ?>">Senjata Pesawat</a>
                            </li>
                        </ul>
                                ...
                                <div class="portlet-body">
									<div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo site_url('cetak_tniad/cetaksenjatapesawatad') ?>" target="_blank">
									...
									<table class="table table-striped table-bordered table-hover" id="sample_2">
										...
										<tbody>
											<?php 
												$no=1;
												foreach($data_senjata_pesawat_ad as $hasil){ 
											?>
											<tr>
												<td><?php echo $no; ?></td>
												...
												<!--<td>
													<a href="<?php echo base_url() .'c_alutsista/edit_senjata_pesawat_ad/'. $hasil->id; ?>" class="btn default btn-xs green">
														<i class="fa fa-edit"></i> Edit 
													</a>
													<a href="<?php echo base_url().'c_alutsista/delete_senjata_pesawat_ad/'. $hasil->id; ?>">
