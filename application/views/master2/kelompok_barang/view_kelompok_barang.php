                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo site_url('c_master/kelompok_barang'); ?>">Kelompok Barang</a>
                            </li>
                        </ul>
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo site_url('c_master/tambah_kelompok_barang') ?>"><button id="sample_editable_1_new" class="btn green">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="sample_2">
                                        ...
                                        <tbody>
                                            <?php
                                            $no = 1;
                                            foreach ($kelompok_barang as $data) {
                                                ?>
                                                <tr class="odd gradeX">
                                                    <td>
                                                        <?php echo $no; ?>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url() . "c_master/edit_kelompok_barang/" . $data->kode; ?>" class="btn default btn-xs green">
                                                            <i class="fa fa-edit"></i> Edit </a>
                                                        <a href="<?php echo base_url() . "c_master/hapus_kelompok_barang/" . $data->kode; ?>">
