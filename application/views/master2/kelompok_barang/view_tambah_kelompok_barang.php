                ...
                <div class="page-content">
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            <li>
                                ...
                                <a href="<?php echo site_url('c_master/kelompok_barang') ?>">Alutsista</a>
                    ...
                    <div class="portlet box green" id="form-organisasi">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo site_url('c_master/simpan_kelompok_barang') ?>" class="horizontal-form" method = "post">
                                <div class="form-body">
