                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo site_url('c_master/tambah_komoditi_barang') ?>"><button id="sample_editable_1_new" class="btn green">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($komoditi_barang as $data) {
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td>
                                                        <?php
                                                            echo $data->kelompok_barang_kode;
                                                        ?>
                                                    </td>
													<td>
                                                        <?php
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url() . "c_master/edit_komoditi_barang/" . $data->kode; ?>" class="btn default btn-xs green">
                                                            <i class="fa fa-edit"></i> Edit </a>
                                                        <a href="<?php echo base_url() . "c_master/hapus_komoditi_barang/" . $data->kode; ?>">
