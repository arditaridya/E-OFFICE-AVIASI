                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo site_url('c_master'); ?>">Kesatuan</a>
                                <i class="fa fa-angle-right"></i>
                            </li>
                            <li>
                                <a href="<?php ?>">Kesatuan</a>
                            </li>
                        </ul>
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo site_url('c_master/tambah_ket_kesatuan') ?>"><button id="sample_editable_1_new" class="btn green">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($ket_kesatuan as $data) {
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url() . "c_master/edit_ket_kesatuan/" . $data->id; ?>" class="btn default btn-xs green">
                                                            <i class="fa fa-edit"></i> Edit </a>
                                                        <a href="<?php echo base_url() . "c_master/hapus_ket_kesatuan/" . $data->id; ?>">
