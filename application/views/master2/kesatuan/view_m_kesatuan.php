                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo site_url('c_master/tambah_kesatuan') ?>"><button id="sample_editable_1_new" class="btn green">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($kesatuan as $data) {
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td>
                                                        <?php
                                                            echo $data->nama_kesatuan;
                                                        ?>
                                                    </td>
                                                    <td>
                                                        <?php
                                                            echo $data->idjenkesatuan;
                                                        ?>
                                                    </td>
                                                    <td>
                                                        <?php
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url() . "c_kesatuan/edit_kesatuan/" . $data->id; ?>" class="btn default btn-xs green">
                                                            <i class="fa fa-edit"></i> Edit </a>
                                                        <a href="<?php echo base_url() . "c_kesatuan/hapus_kesatuan/" . $data->id; ?>">
