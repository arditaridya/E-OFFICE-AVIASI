...
<table style="text-align: left; width: 100%;" border="0" cellpadding="0" cellspacing="0" >
  <thead>
	<tr>
         ...
         <td style="vertical-align: top; text-align: center;"><b>LAPORAN PERSEDIAAN AMUNISI TNI AU</b></td>
...
<table border="1" cellspacing="0" cellpadding="0" width="100%" id="tab1" repeat_header="1">
				...
				<td align="center" colspan="2" width="13%"><b>PERSEDIAAN</b></td>
				<td align="center" rowspan="2" ><b>JUMLAH</b></td>
				<td align="center" rowspan="2"><b>GUN 1 BLN</b></td>
				<td align="center" rowspan="2"><b>KEKURANGAN</b></td>
				...
				if ($tact->kesatuan==$value->kesatuan){
					...
					foreach ($detail as $rom => $goshi) { 
						...
						$tigabp = $satubp * 3 ;
						$enambp = $satubp * 6 ;
						$jp = $goshi->persediaan_pusat + $goshi->persediaan_satuan;
						$allsabp = $satubp + $allsabp ;
						$alljml = $goshi->jml_barang + $alljml ;
						if ($value->idamunisi==$goshi->id_dump_amunisi_au){
