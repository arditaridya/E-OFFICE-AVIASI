                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo site_url('cetak_tniau/lap_alpalsus_au'); ?>">Alpalsus</a>
                            </li>
                        </ul>
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo site_url('cetak_tniau/cetak_alpalsus_au') ?>" target="_blank">
                                    ...
                                    ?>
                                    <table class="table table-striped table-bordered table-hover" id="sample_8" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th rowspan="2">
                                                    No
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($alpalsus_au as $data) {
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td>
                                                        <?php
                                                        echo $data->kondisi_primary;
                                                        ?>
                                                    </td>
                                                    <td>
                                                        <?php
                                                        echo $data->kondisi_secondary;
                                                        ?>
                                                    </td>
                                                    <td>
                                                        <?php
                                                    ...
                                                    <!--<td>
                                                        <a href="<?php echo base_url() . "c_alutsista/edit_alpalsus_au/" . $data->id; ?>" class="btn default btn-xs green">
                                                            <i class="fa fa-edit"></i> Edit </a>
                                                        <a href="<?php echo base_url() . "c_alutsista/hapus_alpalsus_au/" . $data->id; ?>">
