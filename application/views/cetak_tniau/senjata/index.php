                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo site_url('cetak_tniau/lap_senjat_au'); ?>">Senjata</a>
                            </li>
                        </ul>
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo site_url('cetak_tniau/cetak_senjata_au') ?>" target="_blank">
                                    ...
                                    ?>
                                    <table class="table table-striped table-bordered table-hover" id="sample_10" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th rowspan="2">
                                                    No
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($senjata_au as $data) {
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <!--<td>
                                                        <a href="<?php echo base_url() . "c_alutsista/edit_senjata_au/" . $data->id; ?>" class="btn default btn-xs blue">
                                                            <i class="fa fa-edit"></i> Edit </a>
                                                        <a href="<?php echo base_url() . "c_alutsista/hapus_senjata_au/" . $data->id; ?>">
                                                            <button class="btn default btn-xs black" data-toggle="confirmation" data-popout="true" data-original-title="Anda yakin ?" title=""><i class="fa fa-trash-o"></i> Delete</button>
                                                        </a>
