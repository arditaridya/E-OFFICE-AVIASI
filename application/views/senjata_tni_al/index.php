                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo site_url('senjata_tni_al/tambah') ?>">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($model as $row) {
                                                ...
                                                <tr class="odd gradeX" >
													...
													<td><a href="<?php echo site_url('c_master/detail/'.$row->id) ?>" target="_blank" ><?php echo $row->id; ?></a></td>
                                                    <td><?php echo $row->NIK; ?></td>
                                                    <td><?php echo $row->fullname; ?></td>
                                                    <td><?php echo $row->username; ?></td>
                                                    <td>
                                                        <a href="<?php echo base_url(); ?>" class="btn default btn-xs green">
