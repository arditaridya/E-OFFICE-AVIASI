        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <!-- END PAGE HEADER-->
                    <!-- ISI -->
                    <form method="POST" action="<?php echo base_url(); ?>c_grafic/show_amunisi_ad" role="form">
                    <div class="row">
                        <div class="col-md-12">
