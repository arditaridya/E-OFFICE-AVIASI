            ...
            $(function () {
                $('#grafic').highcharts({
                    ...
                    series: [{
                        ...
                        data: [<?php
                            foreach ($chart_barang as $key) {
                                echo "".$key->ops_baik + $key->ops_rusak_ringan + $key->ops_rusak_berat.",";
                            }
                        ?>]
                    }, {
                        ...
                        data: [<?php
                            foreach ($chart_barang as $key) {
                                echo "".$key->non_ops_kons + $key->non_ops_rbe + $key->non_ops_tl + $key->non_ops_reran.",";
                            }
                        ?>]
                    }]
                });
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <!-- END PAGE HEADER-->
                    <!-- ISI -->
                    <form method="POST" action="<?php echo base_url(); ?>c_grafic/show_ranpur_al" role="form">
                    <div class="row">
                        <div class="col-md-12">
