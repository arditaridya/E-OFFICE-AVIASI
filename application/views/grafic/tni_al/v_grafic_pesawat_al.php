            ...
            $(function () {
                $('#grafic').highcharts({
                    ...
                    series: [{
                        ...
                        data: [<?php
                            foreach ($chart_barang as $key) {
                                echo "".$key->ops_siap + $key->ops_tdk_siap.",";
                            }
                        ?>]
                    }, {
                        ...
                        data: [<?php
                            foreach ($chart_barang as $key) {
                                echo "".$key->non_ops_grd + $key->non_ops_kons + $key->non_ops_rb + $key->non_ops_tl.",";
                            }
                        ?>]
                    }]
                });
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <!-- END PAGE HEADER-->
                    <!-- ISI -->
                    <form method="POST" action="<?php echo base_url(); ?>c_grafic/show_pesawat_al" role="form">
                    <div class="row">
                        <div class="col-md-12">
