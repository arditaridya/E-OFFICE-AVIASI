            ...
            $(function () {
                $('#grafic').highcharts({
                    ...
                    series: [{
                        ...
                        data: [<?php
                            foreach ($chart_barang as $key) {
                                echo "".$key->pemakaian_sp + $key->pemakaian_tsp.",";
                            }
                        ?>]
                    }, {
                        name: 'Rusak Ringan',
                        data: [<?php
                            foreach ($chart_barang as $key) {
                                echo "".$key->persediaan_sp + $key->persediaan_tsp.",";
                            }
                        ?>]
                    }]
                });
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <!-- END PAGE HEADER-->
                    <!-- ISI -->
                    <form method="POST" action="<?php echo base_url(); ?>c_grafic/show_senjata_al" role="form">
                    <div class="row">
                        <div class="col-md-12">
