    ...
    <script type="text/javascript">
            $(function () {
                $('#grafic').highcharts({
                    ...
                    series: [{
                        name: 'Tingkat Kesiapan(Siap)',
                        data: [<?php
                            foreach ($chart_barang as $key) {
                                echo "".$key->tingkat_siap.",";
                            }
                        ?>]
                    }, {
                        name: 'Tingkat Kesiapan(Tidak Siap)',
                        data: [<?php
                            foreach ($chart_barang as $key) {
                                echo "".$key->tingkat_tdk_siap.",";
                            }
                        ?>]
                    }, {
                        name: 'Baik',
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <!-- END PAGE HEADER-->
                    <!-- ISI -->
                    <form method="POST" action="<?php echo base_url(); ?>c_grafic/show_kapal_al" role="form">
                    <div class="row">
                        <div class="col-md-12">
