                                ...
                                <div class="portlet-body" style="background-color:#99ccff;">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="<?php echo site_url('provinsi/tambahprovinsi') ?>">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($model as $row) {
                                                ...
                                                <tr class="odd gradeX" bgcolor="#ccccff">
                                                    ...
                                                    <td>
													<center>
                                                        <a href="<?php echo base_url('provinsi/editprovinsi/' . $row->id . ''); ?>" class="btn btn-primary">
                                                            <i class="fa fa-pencil"></i> 
                                                        </a>
                                                        <a href="<?php echo site_url('provinsi/hapus/' . $row->id . '') ?>">
