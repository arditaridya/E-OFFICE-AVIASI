...
class Laporan_pemanfaatan extends CI_Controller{
	...
	public function index($lanud_id){
		...
		$data['data'] = $this->db->query("select a.lokasi,c.bmn,c.bangunan,c.tanah,c.sewa,c.menkeu,c.perjanjian,c.peruntukan,c.penyewa,c.pola_kerjasama from data_aset a,pemanfaatan b,detil_pemanfaatan c where b.lanud='".$lanud_id."' and b.simak=a.simak and c.t_pemanfaatan=b.id order by c.id desc")->result();
