...
class Usermanagement extends CI_Controller {
	...
	public function simpan($lanud_id){
		...
		$img_count = count($_FILES['userfile']);
				...
				$this->db->query("insert into data_aset (lanud,ikn,simak,lokasi,luas,dasar_perolehan,tahun_perolehan,nilai,keterangan,denah) values ('".$_POST['lanud']."','".$_POST['ikn']."','".$_POST['simak']."','".$_POST['lokasi']."','".$_POST['luas']."','".$_POST['dasar_perolehan']."','".$_POST['tahun_perolehan']."','".$zzzo."','".$_POST['keterangan']."','".$namanama."')");
				$query = $this->db->query("SELECT 
										MAX(id) as maxd
										FROM data_aset
